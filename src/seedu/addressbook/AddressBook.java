...
public class AddressBook {
    ...
    private static final String PERSON_PROPERTY_GROUP = "group";
...
//    private static final int PERSON_DATA_COUNT = 4;
    ...
    private enum PERSON_PROPERTY {NAME, PHONE, EMAIL, GROUP};
    ...
    private static String executeFindGroup(String commandArgs) {
        ...
        final ArrayList<HashMap<PERSON_PROPERTY, String>> personsFound = getPersonsInGroup(keywords);
    ...
    private static ArrayList<HashMap<PERSON_PROPERTY, String>> getPersonsInGroup(Collection<String> keyword) {
        final ArrayList<HashMap<PERSON_PROPERTY, String>> matchedPersons = new ArrayList<>();
        for(HashMap<PERSON_PROPERTY, String> person : getAllPersonsInAddressBook()){
    ...
    */
     ...
     * @return
     */
    private static String getGroupFromPerson(HashMap<PERSON_PROPERTY, String> person) {
        return person.get(PERSON_PROPERTY.GROUP);
    }
     ...
     */
    private static HashMap<PERSON_PROPERTY, String> makePersonFromData(String name, String phone, String email, String group) {
        ...
        person.put(PERSON_PROPERTY.GROUP, group);
        return person;
    }
    ...
    private static boolean isPersonDataExtractableFrom(String personData) {
        final String matchAnyPersonDataPrefix = PERSON_DATA_PREFIX_PHONE + '|' + PERSON_DATA_PREFIX_EMAIL + '|' + PERSON_DATA_PREFIX_GROUP;
...
//        final int indexOfGroupPrefix = encoded.indexOf(PERSON_DATA_INDEX_GROUP);
    ...
    private static boolean isPersonDataValid(HashMap<PERSON_PROPERTY, String> person) {
        return isPersonNameValid(person.get(PERSON_PROPERTY.NAME))
                ...
                && isPersonGroupValid(person.get(PERSON_PROPERTY.GROUP));
    }
