...
//    private static final int PERSON_DATA_COUNT = 4;
    ...
    private static String executeFindGroup(String commandArgs) {
        ...
        final ArrayList<HashMap<String, String>> personsFound = getPersonsInGroup(keywords);
    ...
    private static ArrayList<HashMap<String, String>> getPersonsInGroup(Collection<String> keyword) {
        final ArrayList<HashMap<String, String>> matchedPersons = new ArrayList<>();
        for(HashMap<String, String> person : getAllPersonsInAddressBook()){
    ...
    */
     ...
     * @return
     */
    private static String getGroupFromPerson(HashMap<String, String> person) {
        return person.get(PERSON_PROPERTY_GROUP);
    }
     ...
     */
    private static HashMap<String, String> makePersonFromData(String name, String phone, String email, String group) {
        ...
        person.put(PERSON_PROPERTY_GROUP, group);
        return person;
    }
...
//        final int indexOfGroupPrefix = encoded.indexOf(PERSON_DATA_INDEX_GROUP);
    ...
    private static boolean isPersonDataValid(HashMap<String, String> person) {
        return isPersonNameValid(person.get("name"))
                ...
                && isPersonGroupValid(person.get("group"));
    }
